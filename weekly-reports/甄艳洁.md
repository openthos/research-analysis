...
- 下周计划： 1.在网上找到一个tensorflow的学习的视频，被比较多的人推荐，想先看看这个 [CS 20SI: Tensorflow for Deep Learning Research](https://www.bilibili.com/video/av9156347/?from=search&seid=6905181275544516403#page=1) 
           2.把腾讯云实验室剩下的三个实验做完。
           3.计划系统的学习一下深度学习，便于理解tensorflow。（待定，不知道应该从哪儿入手，学习到什么程度）

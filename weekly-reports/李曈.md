...
clang static analyzer是一个通用型的分析工具。对于特定问题，需要自己写分析工具。需要深入理解might_sleep导致atomic context被破坏的问题，需要关注concurrency bug中与破坏互斥相关的已有相关研究和内核中的concurrency bug与atomic context的已有相关研究。 
